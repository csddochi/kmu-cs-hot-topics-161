...
public class TopKPageCount extends Configured implements Tool {
    
	public static void main(String[] args) throws Exception {
        
		System.out.println(Arrays.toString(args));
        int res = ToolRunner.run(new Configuration(), new TopKPageCount(), args);
    ...
    public int run(String[] args) throws Exception {
    	...
    	String tmpPath = "/user/cloudera/tmpResult";
        ...
        job.setMapperClass(PageCount.Map.class);
        job.setReducerClass(PageCount.Reduce.class);
        ...
        job2.setJarByClass(TopKPageCount.class);
    ...
    public static class Map extends Mapper<Text, Text, Text, IntWritable> {
		...
		protected void cleanup(
			...
			// until the Queue's elements is zero take Minimum to print records
			while(queue.size() != 0) {
